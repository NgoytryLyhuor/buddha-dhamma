...
const qas = [
  {
    ...
    tie: 'Life of the Buddha · /life', href: BASE + '/life',
  },
  {
    ...
    tie: 'Not-self (Anattā) · /glossary', href: BASE + '/glossary',
  },
  {
    ...
    tie: 'Kamma & result · /kamma', href: BASE + '/kamma',
  },
  {
    ...
    tie: 'Sīla & perfections · /ethics', href: BASE + '/ethics',
  },
  {
    ...
    tie: 'Samādhi (meditation) · /meditation', href: BASE + '/meditation',
  },
  {
    ...
    tie: 'Sabbe sattā bhavantu sukhitattā · /gathas', href: BASE + '/gathas',
  },
  {
  ...
  },
  {
    ...
    tie: 'Svākkhāto (well-expounded) · /chanting', href: BASE + '/chanting',
  },
  {
    ...
    tie: 'Dāna (giving) · /ethics', href: BASE + '/ethics',
  },
  {
    ...
    tie: 'Famous verses · /gathas', href: BASE + '/gathas',
  },
]
</script>