...
const suttas = [
  ...
  },
  {
    ...
    list: [
      { km: 'ស្រឡាញ់តែអ្វី ដែលមិនមែនជាធម៌ ហើយមិនខ្វល់នឹងធម៌របស់ព្រះអរិយៈ។', en: 'Loving what is against the Dhamma and caring nothing for the Dhamma of the noble ones.' },
      { km: 'ចូលចិត្តតែដេក ចូលចិត្តតែសេពគប់មនុស្ស ខ្ជិលច្រអូស ខឹងងាយ ចិត្តរឹងរូស។', en: 'Fond of sleep, fond of company, indolent, irritable and stubborn.' },
      { km: 'សេពកាមគុណ ទឹកស្រា និងល្បែងស៊ីសង។', en: 'Fond of wanton pleasures, strong drink and gambling.' },
      { km: 'រស់ដោយពឹងទ្រព្យគេ បរិភោគតាមទ្រព្យគេ ជាទម្លាប់។', en: 'Dependent on others, always living off the wealth of others.' },
      { km: 'មិនបំរើឪពុកម្តាយ ដែលចាស់ជរា កន្លងវ័យក្មេងទៅហើយ។', en: 'Refusing to support father and mother when they are old and past their youth.' },
      { km: 'ប្រកាន់ត្រកូល និងទ្រព្យ មើលងាយញាតិរបស់ខ្លួន។', en: 'Proud of family and wealth, scorning his own relatives.' },
      { km: 'បិទបញ្ចប់៖ ហេតុវិនាសទាំងនេះ គួរវៀរចាកទាំងអស់ — អ្នកដែលវៀរបាន មិនចាញ់ទិសណាឡើយ។', en: 'In every case the Buddha ends: these are the causes of ruin — abandon them all, and one is undefeated in every direction.' },
    ],
    raw: '',
