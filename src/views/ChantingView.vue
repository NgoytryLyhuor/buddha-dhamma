...
const chants = [
  ...
  },
  {
    ...
    meanK: 'មង្គលទាំង ៣៨ ប្រការ គឺ៖ មិនសេពគប់ពាល សេពគប់ប្រាជ្ញ បូជាអ្នកគួរបូជា នៅសមគួរ បានធ្វើបុណ្យកន្លង តម្កល់ខ្លួនត្រឹមត្រូវ ចេះច្រើន ចេះសិល្ប៍ មានវិន័យល្អ ពោលពាក្យល្អ បម្រើឪពុកម្តាយ ចិញ្ចឹមបុត្តភរិយា មានកិច្ចការមិនច្របូកច្របល់ ធ្វើទាន បដិបត្តិធម៌ ជួយញាតិ ធ្វើការឥតទោស វៀរពីបាប វៀរស្រា មិនប្រមាទក្នុងធម៌ គោរព សុភាព សន្តោស ដឹងគុណ ស្តាប់ធម៌តាមកាល អត់ធន់ គាប់ពាក្យ បានឃើញព្រះសង្ឃ មានធម្មសាកច្ឆា តាមកាល ប្រព្រឹត្តតបោ ព្រហ្មចរិយៈ ឃើញអរិយសច្ចៈ ដឹងច្បាស់និព្វាន ចិត្តមិនញាប់ញ័រ ដោយលោកធម៌។ អ្នកដែលបរិបូណ៌ ដោយមង្គលទាំងនេះ ឈ្នះគ្រប់ទិស បានសុខចម្រើន គ្រប់កន្លែង។',
    meanE: 'The thirty-eight blessings: not mixing with fools, associating with the wise, honouring the worthy, living in a fitting place, past merit, setting oneself aright, learning and skill, discipline and good speech, supporting mother and father, caring for family, harmlessness, generosity and right conduct, giving up evil and intoxicants, diligence in the Dhamma, respect, humility, contentment, gratitude, timely teaching, patience, gentleness, seeing monks, timely Dhamma discussion, austerity, the holy life, insight into the truths, direct knowledge of Nibbāna, and a mind unshaken by worldly ways. One blessed with all these is undefeated in every direction — safe and happy everywhere.',
