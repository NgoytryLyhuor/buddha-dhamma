...
const suttas = [
  ...
  },
  {
    ...
    list: [
      { km: '១) មិនសេពគប់ជនពាល។', en: '1) Not mixing with fools.' },
      { km: '២) សេពគប់អ្នកប្រាជ្ញ។', en: '2) Associating with the wise.' },
      { km: '៣) បូជាអ្នកគួរបូជា។', en: '3) Honouring the worthy.' },
      { km: '៤) នៅក្នុងប្រទេសសមគួរ។', en: '4) Living in a fitting place.' },
      { km: '៥) បានធ្វើបុណ្យទុកក្នុងកាលមុន។', en: '5) Past good deeds.' },
      { km: '៦) តម្កល់ខ្លួនឲ្យត្រឹមត្រូវ។', en: '6) Setting oneself aright.' },
      { km: '៧) ចេះច្រើន (ពាហុសច្ចៈ)។', en: '7) Much learning.' },
      { km: '៨) ចេះសិល្ប៍។', en: '8) Skill in a craft.' },
      { km: '៩) មានវិន័យហ្វឹកហាត់ល្អ។', en: '9) Well-trained discipline.' },
      { km: '១០) ពោលវាចាល្អ។', en: '10) Pleasant speech.' },
      { km: '១១) បម្រើទំនុកបម្រុងមាតាបិតា។', en: '11) Supporting mother and father.' },
      { km: '១២) ចិញ្ចឹមបុត្ត និងភរិយា។', en: '12) Caring for one\'s children and spouse.' },
      { km: '១៣) ប្រកបកិច្ចការឥតច្របូកច្របល់។', en: '13) An orderly livelihood.' },
      { km: '១៤) ធ្វើទាន។', en: '14) Generosity.' },
      { km: '១៥) បដិបត្តិធម៌។', en: '15) Righteous conduct.' },
      { km: '១៦) ជួយឧបត្ថម្ភញាតិ។', en: '16) Helping relatives.' },
      { km: '១៧) ធ្វើកិច្ចការឥតទោស។', en: '17) Blameless deeds.' },
      { km: '១៨) វៀរចាកបាប (អារតី)។', en: '18) Turning away from evil.' },
      { km: '១៩) វៀរចាកបាប (វិរតី)។', en: '19) Abstaining from evil.' },
      { km: '២០) វៀរចាកគ្រឿងស្រវឹង។', en: '20) Refraining from intoxicants.' },
      { km: '២១) មិនប្រមាទក្នុងធម៌។', en: '21) Diligence in the Dhamma.' },
      { km: '២២) ការគោរព។', en: '22) Respect.' },
      { km: '២៣) ការសុភាពរាបទាប។', en: '23) Humility.' },
      { km: '២៤) ការសន្តោស។', en: '24) Contentment.' },
      { km: '២៥) ការដឹងគុណ។', en: '25) Gratitude.' },
      { km: '២៦) ស្តាប់ធម៌តាមកាល។', en: '26) Hearing the Dhamma in season.' },
      { km: '២៧) ការអត់ធន់។', en: '27) Patience.' },
      { km: '២៨) គាប់ពាក្យ ងាយទូន្មាន។', en: '28) Gentleness and being easy to admonish.' },
      { km: '២៩) បានឃើញសមណៈ។', en: '29) Seeing recluses.' },
      { km: '៣០) ធម្មសាកច្ឆាតាមកាល។', en: '30) Timely discussion of the Dhamma.' },
      { km: '៣១) ប្រព្រឹត្តតបៈ។', en: '31) Austerity.' },
      { km: '៣២) ប្រព្រឹត្តព្រហ្មចរិយៈ។', en: '32) The holy life.' },
      { km: '៣៣) ឃើញអរិយសច្ចៈ។', en: '33) Insight into the noble truths.' },
      { km: '៣៤) ដឹងច្បាស់នូវព្រះនិព្វាន។', en: '34) Realization of Nibbāna.' },
      { km: '៣៥) ចិត្តមិនញាប់ញ័រដោយលោកធម៌។', en: '35) A mind unshaken by worldly ways.' },
      { km: '៣៦) ជាអ្នកឥតសោក។', en: '36) Sorrowless.' },
      { km: '៣៧) ជាអ្នកឥតធូលីកិលេស។', en: '37) Stainless.' },
      { km: '៣៨) ជាអ្នកមានសេចក្តីសុខចម្រើន (ខេមៈ)។', en: '38) Secure and at peace.' },
    ],
